...
const Navbar = () => {
  ...
  const menuItems = [
    ...
    { label: 'Blogs', link: '/blog', ariaLabel: 'Read our blogs' },
    { label: 'Gallery', link: '/gallery', ariaLabel: 'Browse gallery' },
    { label: 'Calendar', link: '/calender', ariaLabel: 'View calendar' },
    { label: 'Contacts', link: '/contacts', ariaLabel: 'Get in touch' }
  ];

  // Social items (you can customize these)
  const socialItems = [
    { label: 'Instagram', link: 'https://www.instagram.com/pict.nakshatra/' },
    { label: 'LinkedIn', link: 'https://www.linkedin.com/company/pict-nakshatra/' }
  ];
